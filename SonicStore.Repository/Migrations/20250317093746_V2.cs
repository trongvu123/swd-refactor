        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    minimum_purchase = table.Column<decimal>(type: "decimal(10,2)", precision: 10, scale: 2, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Promotion_User_created_by",
                        column: x => x.created_by,
                        principalTable: "User",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Promotion_User_updated_by",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_status_order_Order_checkout_id",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Promotion_created_by",
                table: "Promotion",
                column: "created_by");

            migrationBuilder.CreateIndex(
                name: "IX_Promotion_updated_by",
                table: "Promotion",
                column: "updated_by");
